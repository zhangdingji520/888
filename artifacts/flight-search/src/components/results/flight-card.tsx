 ...
 * Falls back to ISO parsing if the dot format doesn't match.
 */
function formatTime(raw: string): string {
  if (!raw) return "";
  // Try "DD.MM.YYYY HH:MM" format from the SOAP API
...
export function FlightCard({ offer }: FlightCardProps) {
  ...
  // Detect overnight: arrival date differs from departure date
